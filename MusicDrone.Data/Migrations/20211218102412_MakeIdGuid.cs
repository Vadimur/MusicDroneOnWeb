    ...
    public partial class MakeIdGuid : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("fd1f380c-0251-44b1-bc43-5452ca8aae14"), "13f77539-df01-4269-8b64-80df2c5414bb", "Users", "USERS" },
                    { new Guid("8df8a551-d3a1-49dd-b77b-86b70f389542"), "efa027e3-a214-4ddb-bf49-2974c327c801", "PremiumUsers", "PREMIUMUSERS" },
                    { new Guid("8a093fc7-fbf4-4236-961e-523a30912657"), "947e932d-57fc-4a1c-9fef-716f4b6e79a7", "Moderators", "MODERATORS" },
                    { new Guid("46024bfa-dad5-48ef-8085-551f628b1028"), "ed2ff921-e548-446f-96eb-d3ace63a95c8", "Administrators", "ADMINISTRATORS" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("047f5983-1f48-4f18-a7ec-e22a4842f565"), 0, "0a62193b-4409-4858-8fc6-4aad83e55cc3", "admin@music.drone", false, "AdminName", "AdminLastName", false, null, "ADMIN@MUSIC.DRONE", "ADMIN@MUSIC.DRONE", "AQAAAAEAACcQAAAAEJNbzXh4RvsVLUHT/hijKzTZnuNkyQLLUC5UIGiFRFIeOwuRzQm4p5Ynso1psfq0FQ==", null, false, null, false, "admin@music.drone" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { new Guid("46024bfa-dad5-48ef-8085-551f628b1028"), new Guid("047f5983-1f48-4f18-a7ec-e22a4842f565") });
